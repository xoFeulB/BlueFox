...
import { AwaitbleWebSocket } from "/modules/BlueFox/websocket.awaitable.js";
              ...
              if (tab.id in $.element.tabs) {
                if ($.element.tabs[tab.id].element) {
                  ...
                  TabsTemplate.querySelector("[Focus]").addEventListener(
                    "click",
                    (event) => {
                      window.open(`/document/focus/index.html#${tab.id}`, "_blank");
                    }
                  );
                  ...
                  TabsTemplate.querySelector("[CaptureScreenshot]").addEventListener(
                    "click",
                    async (event) => {
